...
export const DEFAULT_LESSON_PLAN = `KẾ HOẠCH BÀI DẠY: AMINE
Môn: Hóa học - Lớp 12
Thời gian thực hiện: 2 tiết (90 phút)

I. MỤC TIÊU
1. Kiến thức:
- Nêu được khái niệm amine, cách phân loại amine.
- Viết được công thức cấu tạo và gọi tên một số amine theo danh pháp thay thế.
- Trình bày được đặc điểm cấu tạo phân tử và tính chất vật lí của amine.
- Trình bày được tính chất hoá học đặc trưng của amine: tính base, phản ứng với nitrous acid, phản ứng thế ở nhân thơm của aniline.

2. Năng lực:
- Năng lực hóa học: Viết phương trình hóa học minh họa tính chất hóa học của amine.
- Năng lực chung: Giao tiếp, hợp tác nhóm trong các hoạt động thảo luận.

3. Phẩm chất:
- Trung thực trong việc báo cáo kết quả thí nghiệm.

II. THIẾT BỊ DẠY HỌC VÀ HỌC LIỆU
1. Giáo viên: Hình ảnh mô hình phân tử, phiếu học tập, hóa chất thí nghiệm.
2. Học sinh: Xem trước bài mới, chuẩn bị thiết bị di động có kết nối internet.

III. TIẾN TRÌNH DẠY HỌC

HOẠT ĐỘNG 1: MỞ ĐẦU
- GV cho HS xem đoạn video ngắn về các hợp chất amine trong tự nhiên (mùi tanh của cá).
- Yêu cầu HS suy nghĩ về thành phần hóa học gây ra mùi này.

HOẠT ĐỘNG 2: KHÁI NIỆM, CẤU TẠO VÀ DANH PHÁP
- HS nghiên cứu SGK để trả lời câu hỏi về khái niệm amine.
- GV hướng dẫn cách gọi tên theo danh pháp thay thế.

HOẠT ĐỘNG 3: TÍNH CHẤT HÓA HỌC
- Thí nghiệm 1: Tính base của methylamine.
- Thí nghiệm 2: Phản ứng của aniline với nước bromine.
- HS quan sát hiện tượng, viết phương trình phản ứng.

HOẠT ĐỘNG 4: LUYỆN TẬP VÀ VẬN DỤNG
- Giải quyết các bài tập trong SGK.
- Liên hệ thực tiễn về ứng dụng của amine trong đời sống.`;

export const SAMPLE_LESSON_PLAN = `KẾ HOẠCH BÀI DẠY
Môn: Hóa học - Lớp 12
Tên bài: BÀI 6. AMINE
Thời lượng: 02 tiết
...
I. MỤC TIÊU
1. Về kiến thức:
- Khái niệm amine và phân loại amine (theo bậc của amine và bản chất gốc hydrocarbon).
- Công thức cấu tạo và tên gọi của một số amine.
- Đặc điểm về tính chất vật lí và hóa học của amine.
- Tính chất hoá học đặc trưng của amine: tính chất của nhóm –NH2.

2. Về năng lực:
a) Năng lực hóa học:
- Nhận thức hoá học: Nêu được khái niệm, phân loại amine; Viết được công thức cấu tạo.
- Tìm hiểu thế giới tự nhiên dưới góc độ hoá học: Thực hiện được thí nghiệm về phản ứng của methylamine.

b) Năng lực chung:
- Tự chủ và tự học: Chủ động tìm hiểu kiến thức về amine qua tài liệu.
- Giao tiếp và hợp tác: Thảo luận nhóm hiệu quả.

II. THIẾT BỊ DẠY HỌC VÀ HỌC LIỆU
1. Thiết bị: Máy chiếu, bảng nhóm.
2. Hóa chất: Dung dịch CH3NH2, quỳ tím, HCl.

III. TIẾN TRÌNH DẠY HỌC
Hoạt động 1: Mở đầu
- GV chiếu hình ảnh về mùi tanh của cá và vết côn trùng đốt.
- GV đặt câu hỏi về cách khử mùi và giảm đau.
- HS suy nghĩ và trả lời.

Hoạt động 2: Hình thành kiến thức mới
- Tìm hiểu khái niệm, phân loại amine.
- Quan sát mô hình phân tử methylamine.

Hoạt động 3: Luyện tập
- GV phát phiếu học tập.
- HS làm việc cá nhân và thảo luận nhóm để hoàn thành.

Hoạt động 4: Vận dụng
- Tìm hiểu về ứng dụng của amine trong thực tiễn (thuốc, phẩm nhuộm).`;